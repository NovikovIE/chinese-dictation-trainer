...
words10 = [
    ['正在', 'zhèng zài',
     '（副词）указывает на то, что действие происходит в данный момент (см. грамматический раздел)'],
    ['小吃', 'xiǎochī', ' закуска, перекус'],
    ['饮料', 'yǐnliào', ' напитки'],
    ['因为', 'yīnwèi', ' потому что..; из-за того, что..; так как'],
    ...
    ['打算', 'dǎsuan', ' планировать'],
    ['举办', 'jǔbàn', ' организовывать, устраивать'],
    ['不好意思', 'bùhǎo yìsi', 'прошу прощения, извините, неловко вышло'],
    ['晚会', 'wǎnhuì', ' вечеринка'],
    ['怎么办?', 'zěnme bàn', 'Что делать?'],
    ...
    ['岁', 'suì', ' “лет” сч. сл. для указания возраста'],
    ['支', 'zhī',
     '“ветка” сч.сл. для предметов, похожих на палочки (ручки, кисти, свечки)'],
    ['蜡烛', 'làzhú', ' свеча (восковая)'],
    ['礼物', 'lǐwù', ' подарок'],
    ['宇航员', 'yǔhángyuán', ' космонавт'],
    ['飞船', 'fēichuán', ' космический корабль'],
    ['飞到', 'fēidào', ' долететь до..'],
    ['飞', 'fēi', ' летать'],
    ['太空', 'tàikōng', ' космос'],
    ['进入', 'jìnrù', ' входить, проникать'],
    ['张', 'zhāng', ' сч. сл. для плоских предметов'],
    ['飞往', 'fēiwǎng', ' лететь в направлении чего-л.'],
    ['图片', 'túpiàn', ' картинка'],
    ['周围', 'zhōuwéi', ' вокруг (послелог)'],
    ['颗', 'kē', ' гранула, крупинка, зд.: сч.сл. для звезд и планет'],
    ['行星', 'xíngxīng', ' планета (“движущаяся звезда”)'],
    ['恒星', 'héngxīng', ' звезда (“неподвижная звезда”)'],
    ['棒', 'bàng', '（形容词） круто, классно'],
    ['加加林', 'Jiājiālín', ' Гагарин'],
    ...
    ['日期', 'rìqī', ' дата'],
    ['周', 'zhōu', ' неделя (письм.)'],
    ['礼拜', 'lǐbài', ' неделя (разг.)'],
    ['礼', 'lǐ', ' этикет, правила вежливости, ритуал'],
    ['拜', 'bài', ' приветствовать поклоном'],
    ['圣诞节', 'shèngdànjié', ' Рождество'],
    ['三八节', 'sānbājié', ' 8-е марта (三月八日)'],
    ['五一节', 'wǔyījié', ' 1-е мая （五月一日)'],
    ['宇宙', 'yǔzhòu', ' космос, Вселенная'],
    ['火箭', 'huǒjiàn', ' ракета, челнок (обычно для грузов)'],
    ['卫星', 'wèixīng', ' спутник (астр.)'],
    ['卫', 'wèi', ' охранять, сторожить'],
    ['太阳系', 'tàiyángxì', ' Солнечная система'],
    ['太阳', 'Tàiyáng', ' Солнце'],
    ['月球', 'Yuèqiú', ' Луна'],
    ['冥王星', 'Míngwángxīng', ' Плутон'],
    ['天文学', 'tiānwénxué', ' астрономия'],
    ['等', 'děng', ' ждать'],
    ['呀', 'уа', '(междометие) после гласных звуков употребляется вместо 啊'],
    ['蛋糕', 'dàngāo', ' торт'],
    ['干什么', 'gàn shénme', 'зачем? для чего?'],
    ['干', 'gàn', ' делать'],
    ['打扰', 'dǎrǎo', ' тревожить, беспокоить']
]

words11 = [
    ['应该', 'yīnggāi', 'должно быть, should'],
    ['得', 'de', 'служебная частица'],
    ['就', 'jiù', 'уже, сразу'],
    ['成功', 'chénggōng', 'успех, успешный'],
    ['袋', 'dài', 'пакет'],
    ['炸', 'zhá', 'жаренный в масле / фри'],
    ['土豆', 'tǔdòu', 'картофель'],
    ['片', 'piàn', 'пластинка, ломтик, chips'],
    ['盒', 'hé', 'коробка'],
    ['花生', 'huāshēng', 'арахис'],
    ['开心果', 'kāixīn guǒ', 'фисташки'],
    ['爆米花', 'bào mǐhuā', 'попкорн'],
    ['蛋糕', 'dàngāo', 'торт'],
    ['巧克力', 'qiǎokèlì', 'шоколад'],
    ['钱', 'qián', 'деньги'],
    ['贵', 'guì', 'дорогой, драгоценный'],
    ['卢布', 'lúbù', 'рубль'],
    ['喝', 'hē', 'пить'],
    ['瓶', 'píng', 'бутылка'],
    ...
    ['用', 'yòng', 'использовать/пользоваться'],
    ['一共', 'yígòng', 'итого'],
    ['花', 'huā', 'тратить (деньги / время)'],
    ['戈比', 'gēbǐ', 'копейка'],
    ['折合', 'zhéhé', 'конвертировать'],
    ['人民币', 'rénmínbì', 'юани / RMB'],
    ['算', 'suàn', 'считать'],
    ...
    ['毛', 'máo', 'мао'],
    ['相当于', 'xiāngdāng yú', 'соответствовать'],
    ['等于', 'děngyú', 'равняться'],
    ['分', 'fēn', 'фэнь, 1/100 юаня'],
    ['转', 'zhuǎn', 'перевести, перебросить'],
    ['钱财', 'qiáncái', 'деньги, ценности, богатство'],
    ['算清', 'suànqīng', 'подсчитать, подвести итог'],
    ['甜食', 'tiánshí', 'сладости'],
    ['饼干', 'bǐnggān', 'печенье'],
    ['水果', 'shuǐguǒ', 'фрукты'],
    ['橘子', 'júzi', 'мандарин'],
    ...
    ['葵花籽', 'kuíhuāzǐ', 'семечки подсолнуха'],
    ['饮料', 'yǐnliào', 'напитки'],
    ['可乐', 'kělè', 'Cola'],
    ['橙汁', 'chéngzhī', 'апельсиновый сок'],
    ['美元', 'měiyuán', 'американский доллар'],
    ['欧元', 'ōuyuán', 'евро'],
    ['日元', 'rìyuán', 'японская йена'],
    ['人民币', 'rénmínbì', 'китайский юань (народные деньги)'],
    ['港币', 'gǎngbì', 'гонконгский доллар'],
    ['英币', 'yīng bì', 'английский фунт'],
    ['零钱', 'língqián', 'мелочь, размен'],
    ['国王', 'guówáng', 'царь, правитель'],
    ['与', 'yǔ', '(книжн.) союз и'],
    ['棋盘', 'qípán', 'шахматная доска'],
    ['古', 'gǔ', 'древний'],
    ['印度', 'Yìndù', 'Индия'],
    ['数学', 'shùxué', 'математика'],
    ['西萨·班·达依尔', 'Xīsà Bān Dáyīěr', 'Сисса Бен (ибн) Дахир'],
    ['发明', 'fāmíng', 'изобретение, изобретать'],
    ['国际', 'guójì', 'международный'],
    ['象棋', 'xiàngqí', 'шахматы, китайские шахматы'],
    ['游戏', 'yóuxì', 'игра'],
    ['舍罕 王', 'shěhǎn wáng', 'правитель Ширхам'],
    ['奖赏', 'jiǎngshǎng', 'наградить, награда'],
    ['对', 'duì', 'по отношению к…'],
    ['一点(儿)', 'yìdiǎn (r)', 'немного'],
    ['麦子', 'màizi', 'пшеница'],
    ['又', 'yòu', 'снова, опять'],
    ['张', 'zhāng', 'сч.сл. «плоскость» для плоских предметов'],
    ['第', 'dì', 'служ.сл. для образования порядковых числит.'],
    ['格子', 'gézi', 'клетка, решетка'],
    ['里', 'lǐ', 'внутри (послелог)'],
    ['放', 'fàng', 'класть, ставить / отпускать, расслаблять'],
    ['粒', 'lì', 'сч.сл. зерно, ядро, крупинка, гранула; капсула'],
    ['以后', 'yǐhòu', 'далее (с какого-то момента), потом'],
    ['比', 'bǐ', 'сравнивать (гл.), по сравнению с (предлог)'],
    ['倍', 'bèi', 'раз, крат (= номинал+1)'],
    ['直', 'zhí', 'прямо, непосредственно, без перерыва'],
    ['到', 'dào', 'достигать, доходить, до..'],
    ['完', 'wán', 'закончить'],
    ['开心', 'kāixīn', 'радостный, радоваться'],
    ['觉得', 'juéde', 'чувствовать, ощущать, кажется (кому), думать'],
    ['要求', 'yāoqiú', 'требовать, просить, требование'],
    ['容易', 'róngyì', 'просто, легко'],
    ['实现', 'shíxiàn', 'реализовать, осуществить'],
    ['让', 'ràng', 'приказывать, велеть, разрешать, позволять'],
    ['仆人', 'púrén', 'слуга'],
    ['拿', 'ná', 'носить в руке, держать в руке'],
    ['袋', 'dài', 'сч. сл. мешок, сумка, пакет'],
    ['计数', 'jìshù', 'подсчет, считать'],
    ['工作', 'gōngzuò', 'работа'],
    ['开始', 'kāishǐ', 'начинать (ся)'],
    ['内', 'nèi', 'внутри, в пределах (послелог)'],
    ['空', 'kōng', 'пустой'],
    ['车', 'chē', 'телега, повозка, воз'],
    ['看出', 'kànchū', 'заметить'],
    ['连…也', 'lián… yě', 'даже..'],
    ['全', 'quán', 'полный, целый'],
    ['够', 'gòu', 'достаточно, хватит'],
    ['因为', 'yīnwèi', 'потому что'],
    ['颗', 'kē', 'сч. сл. гранула, крупинка'],
    ['京', 'jīng', 'разряд, 10^16'],
    ['兆', 'zhào', 'разряд, 10^12'],
    ['蒲式耳', 'púshì’ěr', 'бушель (ед. объема)'],
    ['大概', 'dàgài', 'примерно, приблизительно'],
    ['行', 'xíng', 'хорошо, сойдет, достаточно'],
    ['差不多', 'chàbuduō', 'почти, приблизительно'],
    ['世界', 'shìjiè', 'мир, Вселенная'],
    ['所', 'suǒ', 'служ. слово для создания пассива'],
    ['生产', 'shēngchǎn', 'производить'],
    ['发现', 'fāxiàn', 'обнаружить, открыть, открытие'],
    ['欠', 'qiàn', 'задолжать'],
    ['笔', 'bǐ', 'зд.: сч.сл. для счётов, торговых сделок и денежных сумм'],
    ['债', 'zhài', 'долг, обязательство'],
    ['只', 'zhǐ', 'зд.: только лишь'],
    ['办法', 'bànfǎ', 'способ, метод'],
    ['忍受', 'rěnshòu', 'терпеть, сносить'],
    ['没完没了', 'méiwán méiliǎo', 'бесконечный, нескончаемый'],
    ['讨债', 'tǎozhài', 'взыскивать долг'],
    ['砍掉', 'kǎndiào', 'отрубать'],
    ['可能', 'kěnéng', 'возможно, возможность'],
    ['选择', 'xuǎnzé', 'выбирать'],
    ['后面', 'hòumian', 'после, позади, последующий, дальнейший'],
    ['等比级数', 'děngbǐ jíshù', 'геометрическая прогрессия'],
    ['级数', 'jíshù', 'числовой ряд'],
    ['等比', 'děngbǐ', 'пропорция, пропорциональный'],
    ['垓', 'gāi', '10^20'],
    ['秭', 'zǐ', '10^24'],
    ['穰', 'rǎng', '10^28'],
]
...
words12 = [
    ...
    ['惊喜', 'jīngxǐ', 'восторгаться, восхищаться; приятный сюрприз'],
    ['提前', 'tíqián', 'заранее'],
    ['没关系', 'méi guānxi', 'пустяки, ничего страшного'],
    ['藏', 'cáng', 'прятаться'],
    ...
    ['够', 'gòu', 'достаточно, хватит'],
    ['吹', 'chuī', 'дуть'],
    ['介绍', 'jièshào', 'представлять, знакомить с кем-либо/чем-либо, описывать'],
    ['分数', 'fēnshù', 'мат. дробь'],
    ['帮/帮助', 'bāng/ bāngzhù', 'помогать'],
    ['理解', 'lǐjiě', 'понимать, разобраться и объяснить'],
    ['数学', 'shùxué', 'математика'],
    ['课本', 'kèběn', 'учебник'],
    ['例题', 'lìtí', 'мат. пример'],
    ['先', 'xiān', 'сейчас / сначала'],
    ['算', 'suàn', 'посчитать'],
    ['错', 'cuò', 'ошибочный, зд.: рез.морфема'],
    ['再', 'zài', 'еще, снова, опять (в будущем)'],
    ['加', 'jiā', 'добавлять'],
    ['上', 'shàng', 'на, над, зд.: рез. морфема'],
    ['如果', 'rúguǒ', 'если…'],
    ['把', 'bă', 'предлог, вводит винительный падеж (кого-что?)'],
    ['平均', 'píngjūn', 'уравнивать, поровну, средний, в среднем'],
    ['分', 'fēn', 'делить, часть'],
    ['切', 'qiē', 'нарезать на...'],
    ['成', 'chéng', 'превращаться, зд.: рез. морфема.'],
    ['份', 'fèn', 'часть, доля'],
    ['之', 'zhī', 'в письменной речи имеет значение частицы 的'],
    ['叔叔', 'shūshu', 'дядя'],
    ['分子', 'fēnzĭ', 'числитель'],
    ['分母', 'fēn mǔ', 'знаменатель'],
    ['整数', 'zhěngshù', 'целое число / целая часть дроби'],
    ['带分数', 'dài fēnshù', 'дробная часть'],
    ['分数线', 'fēnshù xiàn', 'дробная черта'],
    ['真分数', 'zhēn fēnshù', 'правильная дробь'],
    ['假分数', 'jiǎ fēnshù', 'неправильная дробь'],
    ['小数', 'xiǎoshù', 'десятичная дробь'],
    ['住', 'zhù', 'жить, проживать'],
    ['兄弟', 'xiōngdì', 'братья'],
    ['跟', 'gēn', 'с [кем-л.] (предлог)'],
    ['另外', 'lìngwài', 'другие'],
    ['分别', 'fēnbié', 'по отдельности'],
    ['非常', 'fēicháng', 'очень, чрезвычайно'],
    ['跳', 'tiào', 'прыгать'],
    ['进', 'jìn', 'входить (зд.: рез. морфема)'],
    ['澡盆', 'zǎopén', 'ванна'],
    ['洒', 'sǎ', 'пролить, вылиться'],
    ['出来', 'chūlái', 'выходить наружу (зд.: рез. морфема)'],
